...
/**
 * Created by anarchy on 7/18/15.
 */
public class SumCountTrigger extends TriggerProcess {
    private static final Logger logger = LoggerFactory.getLogger(SumCountTrigger.class);
    ...
    */
    ...
    public TriggerResponse insertTrigger(TriggerRequest request) {
        // vt6 -> This view is meant for "sumcount"
        logger.debug("**********Inside Sum Count Trigger for view maintenance**********");
    ...
    private boolean decrementSumCounterInView(int age, List<Column> viewTableCols, TriggerRequest request, Row resultsLastView) {
        ...
        for (int i = 0; i < viewTableCols.size(); i++) {
            ...
            if (tempCol.getName().equalsIgnoreCase("colaggkey_x")) {
                ...
                updateDecrementQuery.append(tempCol.getName() + " = " + (resultsLastView.getInt
                        (tempCol.getName()) - 1) + ", ");
                ...
                if (age > constraintCountGreater) {
                    updateDecrementQuery.append(tempCol.getName() + " = " + (resultsLastView.getInt(tempCol.getName()) - 1) + ", ");
                }
                ...
                if (age > constraintSumGreater) {
                    updateDecrementQuery.append(tempCol.getName() + " = " + (resultsLastView.getInt(tempCol.getName()) - age) + ", ");
                }
        ...
        updateDecrementQuery.append(" where colaggkey_x = '" + resultsLastView.getString("colaggkey_x") + "'");
    ...
    private boolean handleOverwritingInsert(int age, String colAggKey, TriggerRequest request, Row existingRecordDeltaView) {
        ...
        boolean isDecrementQuerySucc = decrementSumCounterInView(age, columns, request, resultsLastCountView);
    ...
    */
    ...
    public TriggerResponse updateTrigger(TriggerRequest request) {
        logger.debug("**********Inside Sum Count Update Trigger for view maintenance**********");
    ...
    */
    ...
    public TriggerResponse deleteTrigger(TriggerRequest request) {
        logger.debug("**********Inside Sum Count Delete Trigger for view maintenance**********");
